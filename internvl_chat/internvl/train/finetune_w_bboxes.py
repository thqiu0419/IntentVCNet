...
class LazySupervisedDataset(Dataset):
    ...
    def video_get_item(self, data_item):
        ...
        video_path = os.path.join(self.root, video_file.split('/')[-1].split('-')[0], video_file).replace('IntentVC_Enhanced_Annotated', 'IntentVC')
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        logger.info('Loading InternVLChatModelWBbox...')
        ...
        model = InternVLChatModelWBbox.from_pretrained(
        ...
        logger.info('Building InternVLChatModelWBbox...')
        model = InternVLChatModelWBbox(internvl_chat_config, vision_model, llm)
